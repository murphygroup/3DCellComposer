...
mask_dir = bz2.BZ2File(join(file_dir, 'cell_mask_DeepCell-0.12.6_membrane_' + axis + '.pkl'), 'wb')
pickle.dump(cell_mask, mask_dir)

nuc_mask_dir = bz2.BZ2File(join(file_dir, 'nuclear_mask_DeepCell-0.12.6_membrane_' + axis + '.pkl'), 'wb')
